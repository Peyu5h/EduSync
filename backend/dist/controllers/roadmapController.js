...
export const generateRoadmap = async (req, res) => {
    try {
        ...
        const roadmapData = await generateRoadmapWithGemini(sortedTopics, user.name);
...
export const regenerateRoadmap = async (req, res) => {
    try {
        ...
        const roadmapData = await generateRoadmapWithGemini(sortedTopics, existingRoadmap.user.name);
...
async function generateRoadmapWithGemini(weakTopics, userName) {
    ...
    Return the response in the following JSON format:
    {
      ...
      "topics": [
        ...
        return {
            description: "Personalized learning roadmap focusing on your identified weak areas.",
            topics: [
                {
                    title: "Understanding Clustering Algorithms",
                    description: "Learn the fundamentals of clustering algorithms with a focus on agglomerative clustering.",
